...
VALID_REINFORCE_REWARD = 0.3
INVALID_REINFORCE_PENALTY = -0.3

NO_ATTACK_REWARD = -0.1
SKIP_VALID_ATTACK_PENALTY = -12.0
VALID_ATTACK_REWARD = 18.0
PER_TERRITORY_CAPTURE_REWARD = 8.0
INVALID_ATTACK_PENALTY = -0.3

PLAYER_TERRITORY_REWARD = 0.2
ENEMY_TERRITORY_PENALTY = -0.2

NEW_PLAYER_CONTINENT_REWARD = 15.0
NEW_ENEMY_CONTINENT_PENALTY = -10.0

PLAYER_CONTINENT_HOLD_REWARD = 0.15
ENEMY_CONTINENT_HOLD_PENALTY = -0.25

HOARDING_MULTIPLIER = 3.0
HOARDING_PENALTY = -5.0

ENEMY_REINFORCE_PENALTY = -0.1
